                ...
                <section className="header__wrapper">
                    <section className="header__left">
                        ...
                        <nav className="header__nav nav">
                            <ul className='nav__list'>
                                ...
                                <li className='nav__item'><Link to={'addContent'}>Топы</Link></li>
                                ...
                                <li className='nav__item'>
                                    <svg viewBox="0 0 50 50" width="11px" height="11px">
                                        ...
                                        <line fill="none" stroke="#000000" strokeWidth="6" strokeMiterlimit="10"
                                              x1="31.2" y1="31.2" x2="44.5" y2="44.5"/>
                                    </svg>
                                    Поиск
                                </li>
                            </ul>
                    ...
                    <section className="header__right">
                        ...
                        <div className='header__settings'>
                            <svg className="SvgIcon_root__n_a0S" focusable="false" viewBox="0 0 24 24"
                                 aria-hidden="true" aria-label="Preferences">
                                <path
